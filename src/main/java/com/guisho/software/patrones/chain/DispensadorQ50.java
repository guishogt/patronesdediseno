 ...
 * @author lfernandez
 */
public class DispensadorQ50 implements ICadenaDispensamiento {

    private ICadenaDispensamiento siguiente;
    private final int currencyToDispense = 50;
    ...
    public void dispensar(Monto monto) {
        ...
        if (monto.getCantidad() >= this.currencyToDispense) {
            ...
            System.out.println("Soy Q50 Dispensando <" + monto.getCantidad() / this.currencyToDispense + "> billetes pendiente  <" + pendiente + ">");
            if (pendiente>0){
